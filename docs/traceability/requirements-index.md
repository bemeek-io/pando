...
|---|---:|---:|
| Requirements | 238 | — |
| Specified in a design doc | 185 | 77% |
| Assigned to a phase | 137 | 57% |
| Covered by a named test | 140 | 58% |
...
| **R-022** | D | Detection never re-runs implicitly. | 3. Core Invariants | 01, 04 | — | `TestR022_AcceptingSetsTheVariablesGivenWithIt`, `TestR022_DetectionEndpointsAnswerForAnAppThatHasNotDetectedYet`, `TestR022_ReDetectingKeepsHowADependencyIsFilled`, `TestR022_ReDetectingKeepsStorageSomebodyAdded`, `TestR022_ReDetectingKeepsWhatAPersonDecided`, `TestR022_SetEnvPutsAValueWhereTheVariableIsRead` |
...
| **R-027** | D | Authorization decisions, the audit log, the state store, and the identity assertion path live… | 3. Core Invariants | 00, 02, 03, 06, 10 | 00, 08, 11 | `TestR027_AnOwningRoleCanUndoTheRevoke`, `TestR027_ApplicationRoleDoesNotOwnTheSchema`, `TestR027_AuditLogIsNotRewritable`, `TestR027_AuditRemainsImmutableAcrossRestarts` |
| **R-028** | D | Pando observes and reports; it does not remediate the app. | 3. Core Invariants | 03, 05, 08, 10 | 08 | `TestR028_AScreenerCannotForgeAWarningCode` |
...
| **R-075** | D | Anonymous is a real ACL subject, not a bypass. | 6.2 Subjects | 02, 04, 06, 07 | 05 | `TestR075_AnAnonymousCallerIsRefusedByAuthorizationRatherThanAtTheDoor`, `TestR075_AnonymousGrantAllowsUnauthenticatedUse`, `TestR075_AnonymousGrantIsARowAndCannotBeDuplicated`, `TestR075a_APasscodeAppAsksForItsPasscode`, `TestR075a_APasscodeGateIsOnlyOnTheGrantToEveryone`, `TestR075a_GrantAddSharesWithAGroupOrEveryone`, `TestR075a_PublicWithAPasscode` |
| **R-076** | D | Any app owner may grant to anonymous by default. | 6.2 Subjects | 00, 04, 08 | 08 | `TestR076_AnonymousGrantsAreAllowedUnlessExplicitlyForbidden`, `TestR076_ForbiddingAnonymousGrantsNamesTheAppsAnyoneCanReach`, `TestR076_PolicyCanRequireAPasscodeOrForbidPublicSharing`, `TestR076_PublicSharingIsAllowedPasscodeOnlyOrNone` |
| **R-077** | P | The console must never present this as the bare word "public" alone. | 6.2 Subjects | 04, 08 | 08 | — |
| **R-078** | D | Groups may be Pando-native or pushed from an IdP (R-048). | 6.3 Groups | 03 | 08 | `TestR078_ANewTeamMemberGetsWhatTheTeamHas`, `TestR078_DeletingAGroupTakesWhatWasSharedWithIt`, `TestR078_GroupsAreCreatedAndListedByAnAdministrator`, `TestR078_ManyGroupsCanBeMadeAndNamesAreUnique` |
...
| **R-081** | D | Five immutable built-in roles ship out of the box. | 6.4 Verbs and roles | 02, 04, 06 | 01 | `TestR081_ABuiltInRoleCannotBeDeleted`, `TestR081_ACreatorManagesTheAppsTheyMakeAndNothingElse`, `TestR081_AdministratorHoldsNoAppVerb`, `TestR081_AdministratorIsImmutableToo`, `TestR081_AdministratorsLookAfterEveryAppButDoNotUseIt`, `TestR081_AnAdministratorCanHandOver`, `TestR081_AnAdministratorManagesAnAppSomebodyElseMade`, `TestR081_BuiltInRoleVerbSets`, `TestR081_BuiltInRolesAreImmutable`, `TestR081_CreatorHoldsOnlyAppCreate`, `TestR081_EveryBuiltInRoleIsListed`, `TestR081_SeededVerbSetsMatchTheRequirement`, `TestR081_TheLastAdministratorCannotBeRemoved` |
| **R-082** | D | Custom roles may be composed from the verb list and assigned to users or groups. | 6.4 Verbs and roles | 02, 04, 06 | 01, 08 | `TestR082_ACustomRoleCannotTakeAnExistingRolesName`, `TestR082_ACustomRoleIsCreatedFromVerbsAndCanBeRemoved`, `TestR082_ACustomRoleSomeoneHoldsCanBeDeleted`, `TestR082_NoVerbImplicationGraph` |
...
| **R-087** | D | Pando does not claim to defend against its own host operator. | 6.4 Verbs and roles | 06 | 01, 05 | `TestR087_AnOrdinaryUserSeesOnlyTheirOwnApps` |
| **R-088** | D | An installation cannot be left with nobody who can administer it. | 6.4 Verbs and roles | 06 | — | `TestR088_DeletingTheGroupThatIsTheOnlyAdministratorIsRefused`, `TestR088_DeletingTheRoleThatIsTheOnlyWayToManageAccountsIsRefused`, `TestR088_TheLastAdministratorCannotBeRemoved`, `TestR088_TheLastAdministratorCannotBeRevoked`, `TestR088_TheLastAdministratorCannotBeTakenOutOfTheirGroup` |
...
| **R-097** | D | A trial run in throwaway isolation is part of detection. | 7.2 Detection | 01, 03, 07, 10 | 06 | `TestR097_ATrialRunObservesTheBoundPort`, `TestR097_AWatchedPortAnswersTheQuestionInsteadOfAPerson`, `TestR097_ObservedPortsAreMarkedObservedNotFramework`, `TestR097_TheTrialRunnerIsNilWhenNoRuntimeIsConfigured` |
| **R-098** | D | The user reviews the proposal, then it pins. | 7.2 Detection | 10 | — | `TestR098_AScreeningCannotFloodTheReview` |
| **R-099** | D | Compose constructs incompatible with the boundary are rejected or rewritten, with the reason… | 7.2 Detection | 00, 01 | 06 | `TestR099_ABlockedProposalIsNotScreened`, `TestR099_ACandidateThatImportedNothingIsNotAdopted`, `TestR099_AFileTooBigOrTooBinaryToCarryIsRefused`, `TestR099_APublishedHostPortIsRewrittenNotHonored`, `TestR099_ARefusedComposeFileIsNotOutbidByTheDockerfile`, `TestR099_ARejectedComposeFileDoesNotSilentlyBecomeABuildpackGuess`, `TestR099_ConstructsThatBreakTheBoundaryAreRejectedWithReasons`, `TestR099a_ACarriedFileNeedsSomewhereToLand` |
...
| **R-102** | D | Ask, never guess. | 7.3 When detection cannot decide | 03, 04, 08, 10 | 08 | `TestR102_ACloseCallBecomesAQuestion`, `TestR102_AnsweringTheTieBreakAdoptsThatReading` |
| **R-103** | D | The number of questions is the product metric. | 7.3 When detection cannot decide | 01, 08, 10 | 06, 08, 11 | — |
| **R-104** | D | Questions are blockers; everything else is configuration. | 7.3 When detection cannot decide | 03, 08, 10 | 08 | `TestR104_AFrameworkPortIsADefaultRatherThanAQuestion`, `TestR104_AStartCommandFromTheBuildPlanIsNotAsked`, `TestR104_TheProposalCarriesTheInstallsOwnAnswers` |
...
| **R-106** | D | AI assistance is optional supporting functionality, never required. | 7.3 When detection cannot decide | 03, 10 | 11 | `TestR106_AMonorepoEntrypointIsWhatScreeningIsFor` |
| **R-107** | D | The correct failure: a repo needs Postgres and never mentions it anywhere — no compose… | 7.3 When detection cannot decide | 01, 10 | 06 | `TestR107_ACrashDoesNotInventASlotTheRepoNeverDeclared`, `TestR107_ACrashingTrialReturnsItsLog` |
| **R-330** | D | Screening reviews Pando's own answer; it is not a second detector. | 7.4 Screening a deployment plan | 10 | 11 | `TestR330_AScreeningReadsTheRepositoryThenSubmitsFindings`, `TestR330_ScreeningDoesNotReRankTheAuction` |
| **R-331** | D | Screening amends the spec and nothing else. | 7.4 Screening a deployment plan | 10 | — | `TestR331_AScreenerCannotOverwriteAValueAPersonSet`, `TestR331_AScreenerCannotWriteOverADependencyOrASecret`, `TestR331_AScreenerMayReplaceAValueDetectionInferred`, `TestR331_AnAmendmentLandsInTheDraftSpecAndIsAttributed` |
| **R-332** | D | The amendable surface is a closed set. | 7.4 Screening a deployment plan | 10 | 11 | `TestR332_ACommandLineIsHandedToAShell`, `TestR332_AnAmendmentKindThatIsNotInTheSetSaysNothing`, `TestR332_AnAmendmentMustSayWhichWorkloadWhenThereIsNoPrimary`, `TestR332_EachAmendmentKindLandsWhereItSays`, `TestR332_EachAmendmentKindRefusesWhatItMust`, `TestR332_RefusalsAreRecordedNeverSilent`, `TestR332_TheToolSchemaIsTheClosedSet` |
| **R-333** | D | An observation outranks a screening. | 7.4 Screening a deployment plan | 10 | 11 | `TestR333_AScreenedPortFillsWhatWasNotObserved`, `TestR333_AScreeningDoesNotOverruleTheTrialRun`, `TestR333_AnObservationOutranksAScreening` |
| **R-334** | D | Every amendment carries evidence and is attributed. | 7.4 Screening a deployment plan | 10 | 11 | `TestR334_AnAmendmentRestingOnNothingIsRefused`, `TestR334_AnAppliedAmendmentRecordsScreenedProvenance`, `TestR334_AnEmptyEvidenceEntryIsIgnoredRatherThanChecked`, `TestR334_EvidenceThatIsNotInTheRepositoryIsRefused`, `TestR334_WithoutAReadableRepositoryNothingIsApplied` |
| **R-335** | D | Screening never blocks and never fails a detection. | 7.4 Screening a deployment plan | 10 | 11 | `TestR335_AModelThatStopsWithoutFindingsIsAFailureNotACleanBill`, `TestR335_AProviderThatFailsDoesNotFailTheDetection`, `TestR335_ARefusalIsReportedAsAFailure`, `TestR335_AnUnconfiguredAdapterFailsRatherThanPretends`, `TestR335_EveryWayRunCanFailIsASkipWithAReason`, `TestR335_NoAdapterConfiguredLeavesTheProposalAlone` |
| **R-336** | P | Screening is on when an AI adapter is configured. | 7.4 Screening a deployment plan | 10 | 11 | `TestR336_AnAdapterTurnedOffForScreeningDoesNotScreen`, `TestR336_HostPolicyCanForbidAIScreening`, `TestR336_HostPolicyCanForbidScreeningInstallWide`, `TestR336_ScreeningIsOnWhenTheAdapterIsConfigured` |
| **R-337** | D | Screening sends repository contents to the adapter's provider, and records that it did. | 7.4 Screening a deployment plan | 10 | 11 | `TestR337_WhatWasReadIsRecordedInOrder` |
| **R-338** | D | A screener may answer Pando's own questions. | 7.4 Screening a deployment plan | 10 | 11 | `TestR338_AnAnswerIsHeldToTheSameEvidenceRule`, `TestR338_AnAnswerMayNotBeEmptyOrGivenTwice`, `TestR338_AnAnswerToAQuestionNobodyAskedIsRefused`, `TestR338_AnAnsweredQuestionStopsBeingAsked` |
| **R-339** | P | Screening is bounded by files read, bytes read, and wall clock, declared per adapter and | 7.4 Screening a deployment plan | 10 | 11 | `TestR339_RereadingAFileIsFree`, `TestR339_RunLowersTheBudgetToTheAdaptersAndSetsADeadline`, `TestR339_TheBudgetIsTheLowerOfWhatCoreAsksAndWhatTheAdapterWillDo`, `TestR339_TheByteBudgetIsEnforced`, `TestR339_TheFileBudgetIsEnforced` |
...
| **R-132** | D | Resolution is never silent. | 9. Slots and Services | 00, 01, 04, 05, 07, 10 | 02, 03, 06 | `TestR132_EveryUnfilledSlotIsNamed`, `TestR132_PlanningAPinnedSpecReportsWhatIsMissingAtPlanTime`, `TestR132_SlotUnfilledCarriesRemedyAndDetails`, `TestR132_UnfilledRequiredSlotBlocksDeploy` |
...
| **R-221** | P | Health signal sources, in order: compose healthcheck if declared, HTTP endpoint if configured,… | 16.1 Health | 01, 03, 05, 07 | 04, 07 | `TestR221_NoHealthConfiguredMeansNoHealthPlan`, `TestR221_NoHealthSignalIsNotUnhealthy`, `TestR221_TheHealthProbeUsesWhateverTheImageHas` |
...
| **R-227** | P | Auditable events: every spec mutation, every grant change, every deploy, every secret write,… | 16.3 Audit | — | — | `TestR227_TheAuditLogFindsEverythingToDoWithOneAccount`, `TestR227_TheAuditLogIsBehindItsOwnVerb`, `TestR227_TheAuditLogIsReadableBehindItsOwnVerb`, `TestR227_TheRestoreIsRecordedInTheInstallItProduced` |
...
| **R-253** | D | Adapters are compiled in-tree. | 18. Adapters | 00, 03, 08, 10 | 00, 03 | `TestR253_AnAdapterSavedAfterStartupIsMarkedUntilARestart`, `TestR253_EverySeededAdapterHasAnImplementation`, `TestR253_RestartingIsForWhoeverMayChangeAdapters` |
| **R-254** | D | Every adapter advertises capabilities as data — `isolation_class`,… | 18. Adapters | 00, 01, 03, 04, 05, 07, 10 | 03 | `TestR254_CapabilitiesAreHonest`, `TestR254_CapabilitiesAreReportedHonestly`, `TestR254_CapabilitiesReportPortModeOnly`, `TestR254_CapabilityUnsupportedBlocksDeploy`, `TestR254_TrialCapabilitiesAreDeclaredNotAssumed` |
...
| **R-258** | D | AI is the tenth adapter category. | 18. Adapters | 03, 10 | 11 | `TestR258_AIIsAnAdapterCategory`, `TestR258_AnAIAdapterConfiguredWithoutBeingMarkedDefaultIsStillFound`, `TestR258_NoAIAdapterIsAnOrdinaryOutcome` |
| **R-259** | D | An AI adapter declares which functions it performs as capabilities data. | 18. Adapters | 10 | 11 | `TestR259_CapabilitiesAreDataNotATypeAssertion` |
