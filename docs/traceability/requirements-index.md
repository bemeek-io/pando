...
| **R-310** | D | Screening reviews Pando's own answer; it is not a second detector. | 7.4 Screening a deployment plan | 09 | 11 | `TestR310_ScreeningDoesNotReRankTheAuction` |
| **R-311** | D | Screening amends the spec and nothing else. | 7.4 Screening a deployment plan | 09 | — | `TestR311_AScreenerCannotOverwriteAValueAPersonSet`, `TestR311_AScreenerCannotWriteOverADependencyOrASecret`, `TestR311_AnAmendmentLandsInTheDraftSpecAndIsAttributed` |
| **R-312** | D | The amendable surface is a closed set. | 7.4 Screening a deployment plan | 09 | 11 | `TestR312_AnAmendmentKindThatIsNotInTheSetSaysNothing`, `TestR312_RefusalsAreRecordedNeverSilent` |
...
| **R-314** | D | Every amendment carries evidence and is attributed. | 7.4 Screening a deployment plan | 09 | 11 | `TestR314_AnAmendmentRestingOnNothingIsRefused`, `TestR314_AnAppliedAmendmentRecordsScreenedProvenance`, `TestR314_EvidenceThatIsNotInTheRepositoryIsRefused`, `TestR314_WithoutAReadableRepositoryNothingIsApplied` |
| **R-315** | D | Screening never blocks and never fails a detection. | 7.4 Screening a deployment plan | 09 | 11 | `TestR315_AProviderThatFailsDoesNotFailTheDetection`, `TestR315_AnUnconfiguredAdapterFailsRatherThanPretends`, `TestR315_NoAdapterConfiguredLeavesTheProposalAlone` |
| **R-316** | P | Screening is on when an AI adapter is configured. | 7.4 Screening a deployment plan | 09 | 11 | `TestR316_HostPolicyCanForbidScreeningInstallWide`, `TestR316_ScreeningIsOnWhenTheAdapterIsConfigured` |
...
| **R-318** | D | A screener may answer Pando's own questions. | 7.4 Screening a deployment plan | 09 | 11 | `TestR318_AnAnswerIsHeldToTheSameEvidenceRule`, `TestR318_AnAnswerToAQuestionNobodyAskedIsRefused`, `TestR318_AnAnsweredQuestionStopsBeingAsked` |
| **R-319** | P | Screening is bounded by files read, bytes read, and wall clock, declared per adapter and | 7.4 Screening a deployment plan | 09 | 11 | `TestR319_RereadingAFileIsFree`, `TestR319_TheBudgetIsTheLowerOfWhatCoreAsksAndWhatTheAdapterWillDo`, `TestR319_TheByteBudgetIsEnforced`, `TestR319_TheFileBudgetIsEnforced` |
