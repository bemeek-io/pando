...
//
// It is the enforcement point for R-332 and R-333, and it lives in core for the
...
//
// Nothing here fails a detection. R-335: a screening that cannot run, or whose
// every amendment is refused, leaves the proposal exactly as the deterministic
// pipeline produced it. Design 10 is the argument; §4.1 is this rule.
package screening
